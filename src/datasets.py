...
def load_dataset(base_path,
    ...
    # If possible, load a previously generated DataFrame containing the list of
    # image file names along with their corresponding LaTeX formulas. Else,
    # generate it.
    if Path(base_path / 'images_df.json').exists():
        image_files = pd.read_json(base_path / 'images_df.json')
    else:
