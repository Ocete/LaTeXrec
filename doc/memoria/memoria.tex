...
\begin{itemize}
	...
	\item % TODO: Trabajo propuesto pal futuro: ajustar ResNet u otra red convolucional similar
	\item  % TODO: hablar de como no sabemos si la codificacion posicional 2d como tal tiene un efecto positivo o negativo en el modelo, y que hay que estudiarla mas a fondo.
\end{itemize}
